const Map<String, String> polish = {
  "objectives": "Cele",
  "evidences": "Dowód",
  "ghost.name": "Imię ducha",
  "emf.reader": "Czytanie EMF",
  "below.10c.50f": "Poniżej 10 ° C",
  "dirt.water": "Brudna woda",
  "ghost.photo": "Zdjęcie ducha",
  "motion.sensor": "Czujnik ruchu",
  "crucifix": "Krucyfiks",
  "ghost.event": "Wydarzenie Ghost",
  "smudge.sticks": "Kadzidło",
  "salt.footprint": "Ślad w soli",
  "clear": "CZYŚCIĆ",
  "emf.level.5": "Poziom EMF 5",
  "fingerprints": "Odciski palców",
  "freezing.temperatures": "Niska temperatura",
  "ghost.orbs": "Phantom Orb",
