const Map<String, String> germany = {
  ...
  "banshee.description1":
      "Die Banshee ist einer der zwöf Geister in Phasmophobia. Sie ist ein Jäger und wird alles attackieren. Es ist bekannt, dass sie ihre Opfer stalkt bis sie jemanden tötet.",
  "banshee.description2":
      "Im Gegensatz zu anderen Geistern, die häufig ihr ausgewähltes Ziel zwischen den Jagden wechseln, zielen Banshees bei jeder Jagd immer auf denselben Spieler, bis sie erfolgreich getötet wurden. Das bedutet, dass die anderen Spieler vor der Macht der Banshee sicher sind, solange ihr Ziel lebt. Dies erschwert aber auch die Ausführung von Zielen durch den Zielspieler.",
  "banshee.strength": "Eine Banshee wird jeweils nur eine Person jagen.",
  "banshee.weakness":
  ...
  "crucifix.details":
      "Damit das Kruzifix eine Jagd erfolgreich verhindern kann, muss es sich zu Beginn der Jagd in der Nähe des Geistes befinden. Das Kruzifix hat für die meisten Geister eine Reichweite von 3 Metern (5 Meter für die Banshee). Wenn der Geist die Jagd einleitet, prüft er, ob er sich in Reichweite eines Kruzifixes befindet. Wenn dies der Fall ist, beginnt die Jagd nicht, er schaltet alle Lichter aus und nimmt eine von zwei \"Haltbarkeiten\", die das Kruzifix hat.",
  "demon.description1":
      "Der Dämon ist einer der zwöf Geister in Phasmophobia. Er ist mit einer der schlimmsten Geister die man finden kann. Er ist bekannt dafür ohne Sinn und Verstand anzugreifen und dies ohne jegliche Vorwarnung. Obwohl das häufig konventionellere Untersuchungsmethoden behindert, können Geisterjäger das Ouija-Board auch nutzen, ohne ihre geistige Gesundheit zu verringern.",
  "demon.description2":
      "Wenn die Ermittlungen und Ziele nicht schnell erledigt werden, können Dämonen zum herausforderndsten Geist werden. Sie sind dafür berüchtigt, häufig Jagden zu initiieren. Eine Eigenschaft die durch niedrigere geistige Gesundheit und höhere Schwierigkeiten wie im Profi-Modus verstärkt wird, bei denen Jagden viel länger dauern. Unter Berücksichtigung all dieser Faktoren jagen Dämonen in ihrer aggressievsten Form in Intervallen von nur einer halben Minute, was die Spieler dazu zwingt, mehr Zeit damit zu verbringen, sich zu verstecken als nachzuforschen.",
  "demon.strength": "Dämonen greifen viel öfter an, als andere Geister.",
  "demon.weakness":
      "Erfolgreiche Befragungen des Ouija-Boards über den Dämon verringern nicht den Geisterzustand.",
  "demon.evidences": "Gefriertemperaturen | Geisterbuch | Geisterbox",
  "dirt.water.description":
      "Fotografieren sie dreckiges Wasser in einem Waschbecken.",
  "dirt.water.details":
      "Ein Geist kann auf zwei Arten schmutziges Wasser erzeugen: durch Interaktion mit einem bereits mit Wasser gefüllten Becken oder durch Aktivierung eines leeren. Dies kann nützlich sein, um den allgemeinen Standort des Geistes zu bestimmen.",
  ...
  "fingerprints.description1":
      "Fingerabdrücke sind eine Art von Beweisen der Geister, um herauszufinden um welche Art von Geist es sich handelt. Sie bleiben zurück, wenn sie mit der Umgebung interagieren. Sie können Fingerabdrücke mit der UV-Taschenlampe oder dem Leuchtstab sehen.",
  "fingerprints.howitworks1":
      "Ein Geist hinterlässt Fingerabdrücke, wenn er mit der Umgebung interagiert. Die häufigsten Orte sind: Interaktion mit einer Tür; Interaktion mit einem Lichtschalter; An ein Fenster klopfen.",
  ...
  "fingerprints.howitworks4":
      "Fingerabdrücke müssen beim Fotografieren mit einer Fotokamera nicht sichtbar sein und werden im Journal als \"Fingerabdrücke\" gekennzeichnet. Dadurch können sie versehentlich mit einem fehlerhaften Foto entdeckt werden.",
  ...
  "freezing.temperatures.howitworks1":
      "In einem Raum wo sich ein Geist aufhält beginnt die Temperatur zu sinken. Wenn Gefriertemperaturen ein Beweis sind, sinkt die Temperatur dreimal so schnell. Wenn sich ein Geist in einem Raum befindet, in dem Gefriertemperatur kein Beweis ist, kann er die Temperatur nur auf 5°C senken. Es gibt jedoch eine Fehlertolleranz von 2°C am Thermometer, sodass ein Raum so niedrig wie 3°C erscheinen kann, wenn der Geist keine Gefriertemperaturen verursacht.",
  ...
  "ghost.photo.details":
      "Verwenden Sie die Fotokamera, um ein Foto des Geistes zu machen. Die Kamera hat einen Blitz welcher doppelt so hell ist wie die normale Taschenlampe und dreimal so groß ist wie die Reichweite des Leuchtstabs. Sie kann Bilder durch Wände, Türen, Garagentore, Fenster und fast alle Oberflächen aufnehmen, wenn man in der Lage ist das Objektiv durch diese zu klemmen (in VR sehr einfach).",
  "ghost.writing.description1":
      "Das Geisterbuch ist ein Beweis, der verwendet wird, um zu bestimmen, welcher Geist den Ort heimsucht.",
  "ghost.writing.howitworks1":
      "Wenn das Geisterbuch ein Beweisstück ist, hat der Geist eine 5zu12 Chance, mit dem Geisterbuch zu interagieren. Sie können die Geisteraktivität im Raum erhöhen, um die Wahrscheinlichkeit zu erhöhen, dass dies auftritt.",
  ...
  "jinn.description1":
      "Der Dschinn ist einer der zwöf Geister in Phasmophobia. Er ist ein territorialer Geist, der angreift, wenn er bedroht wird. Es ist auch bekannt, dass er während der Jagd schneller wird.",
  "jinn.description2":
      "Dschinns interagieren mehr mit der Elektronik als die anderen Geister. Sie können Telefone klingeln lassen, Radios aktivieren, Fernseher einschalten oder Autoalarme häufiger auslösen. Dies gilt auch für Lichtschalter, die dazu führen können, dass unsichere Ermittler einen Dschinn mit einem Mare oder einem Poltergeist verwechseln. Obwohl der Mare auch die Möglichkeit hat, das Licht auszuschalten, schalten sie das Licht nicht oft wieder ein, wie es der Dschinn tut. Und Poltergeister stören eher allgemeinere Objekte, die keine Lichtschalter sind, wie z. B. Türen.",
  "jinn.strength":
  ...
  "low.temperature.description":
      "Finde einen Raum unter 10° Celsius mit einem Thermometer.",
  "low.temperature.details":
      "Das Thermometer liest die Temperatur, indem es einen 6 Meter Strahl in die Richtung wirft, in die der Spieler schaut, was es zu einem Richtungswerkzeug macht. Die angezeigte Temperatur schwankt innerhalb eines Bereichs von ± 2 Grad, sowohl für Celsius als auch für Fahrenheit.",
  "mare.description1":
      "Der Mare ist einer von zwölf Arten von Geistern in Phasmophobia. Ein Mare ist die Quelle von allen Albträumen. Sie wird bei Nacht am stärksten. Es wird erzählt, dass eine Mare den Verstand von Menschen kontrollieren kann. Mare haben eine höhere Chance, bei Dunkelheit Jagden zu starten, insbesondere wenn die Lichter im Geisterraum ausgeschaltet sind. Er neigt dazu, Lichter und den Sicherungskasten mehr auszuschalten als jeder andere Geistertyp. Wenn ein Geist das Licht wieder einschaltet, ist es jedoch viel wahrscheinlicher, dass es sich um einen Poltergeist oder Dschinn handelt. Ein aktiver Mare, der Spieler mit geringer geistiger Gesundheit verfolgt, hat die Fähigkeit, innerhalb weniger Augenblicke Jagden zu starten, sodass er sogar mit den Agressionen der Dämonen konkurrieren kann.",
  "mare.strength":
      "Eine Mare hat eine erhöte Chance anzugreifen wenn Sie sich im Dunkeln aufhalten.",
  "mare.weakness":
      "Schaltet man die Lichter um einen Mare ein ist die Chance angegriffen zu werden eher gering.",
  ...
  "oni.description1":
      "Der Oni ist einer der zwöf Geister in Phasmophobia. Oni's sind Verwandte des Dämons und besitzen unglaubliche Stärke. Gerüchten zufolge sind sie aktiver in der Nähe ihres Opfers. Dies kann dazu führen, dass Spieler ihn mit einem Dämon verwechseln, vorausgesetzt, sie bleiben während der gesamten Mission nahe beieinander und trennen sich nie. Diese Kraft wirkt jedoch auch dagegen. Es ist einer der aktivsten Geister im Spiel und gibt Beweise leichter an eine Gruppe von Ermittlern weiter. Dies kann zu großzügigen und schnellen Ermittlungen führen, wenn ein Oni die erforderlichen Beweise schnell preisgibt.",
  "oni.description2":
      "Anders als bei den meisten anderen Geistertypen ist das Aufteilen die beste Verteidigungsmethode bei der Suche nach einem Oni, da er viel weniger aktiv ist, wenn die Spieler alleine sind. Dies kann zwar eine nachteilige Strategie sein, insbesondere wenn sich herausstellt, dass der Geist ein Banshee ist, aber es kann den Spielern auch ermöglichen, den Geisterraum schneller zu finden und zu verhindern, dass sie sich während der Jagd in Verstecken zusammenkauern.",
  "oni.description3":
  ...
  "phantom.description2":
      "Der Phantom ist einer der zwölf Geister in Phasmophobia. Entgegen der landläufigen Meinung kann das Phantom nach Verwendung eines Ouija Boards keinen Besitz der Geisterjäger ergreifen.",
  "phantom.strength":
  ...
  "poltergeist.strength":
      "Ein Poltergeist kann mehrere Objekte auf einmal werfen.",
  "poltergeist.weakness":
      "Ein Poltergeist ist in einem leeren Raum fast inaktiv.",
  ...
  "revenant.description2":
      "Im Gegensatz zu anderen Geistern, bei denen beim Starten einer Jagd häufig ein bestimmtes Ziel ausgewählt wird, kann der Revenant die Ziele frei wechseln, wenn sich ein anderer Spieler in der Nähe befindet. Insbesondere einer, der in Sichtweite und verfügbar ist und dessen Ziel, den Spieler bequemer zu töten, einfacher erreichbar ist.",
  ...
  "spirit.box.howitworks6": "Ortsbezogene Fragen",
  ...
  "wraith.description2":
      "Das Gespenst ist einer von zwölf Geistern in Phasmophobia. Es ist dafür bekannt, dass es in der Lage ist zu \"fliegen\", was dazu führt, dass es beim Bewegen (größtenteils) keine Schritte erzeugt, und auch durch Türen, Schränke und Schließfächer sehen kann, wenn es Spieler jagt, die somit ein kreativeres Verstecken benötigen.",
  "wraith.strength":
      "Ein Gespenst berührt nie den Boden wodurch er nicht durch Fußabdrücke gefunden werden kann.",
  "wraith.weakness":
  ...
  "enable.discard.evidence.long.press":
      "Aktivieren Sie diese Option, um Beweise durch langes drücken manuell zu verwerfen.",
