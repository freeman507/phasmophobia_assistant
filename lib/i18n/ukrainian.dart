const Map<String, String> ukranian = {
  "objectives": "об'єктивний",
  "evidences": "Докази",
  "ghost.name": "Ім'я привида",
  "emf.reader": "Зчитування ЕРС",
  "below.10c.50f": "Нижче 10 ° C",
  "dirt.water": "Брудна вода",
  "ghost.photo": "Привид фото",
  "motion.sensor": "Датчик руху",
  "crucifix": "Розп’яття",
  "ghost.event": "Подія привидів",
  "smudge.sticks": "Ладан",
  "salt.footprint": "Слід у солі",
  "clear": "ЧИСТИТИ",
  "emf.level.5": "ЕРС рівень 5",
  "fingerprints": "Відбитки пальців",
  "freezing.temperatures": "Низька температура",
  "ghost.orbs": "Фантомна куля",
  "ghost.writing": "Написання привидів",
  "spirit.box": " коробка привидів",
  "selected": "Вибрано",
  "discarded": "Викинуто",
  "spirit": " Дух",
  "wraith": "wraith",
  ...
  "possible.ghosts": "Можливі привиди",
  "ghost": "Привид",
  "strengths": "Сили",
  "weakness": "Слабкість",
  "language": "Мова",
